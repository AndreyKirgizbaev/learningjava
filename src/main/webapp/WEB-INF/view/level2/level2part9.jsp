            ...
            <div class="level-c__content">
                ...
                <div class="col-10">
                    ...
                    <div class="row">
                        ...
                        <security:authorize access="hasRole('ROLE_L2P10')" var="nextLvl"/>
            ...
            $(document).ready(function () {
                    ...
                    $.post('/level2part9compile', JSON.stringify(dataPayload))
                        .done(function (response) {
                            ...
                            if (response["result"] === true) {
                                ...
                                $("#next").removeClass("btn-grey").addClass("btn-blue").attr("href", "${level2part10}");
                            } else {
                ...
                $("#writeComment").click(function () {
                    ...
                    if (comment === "") {
                        ...
                        var dataPayload = {"comment": comment, "theme": "29"};
