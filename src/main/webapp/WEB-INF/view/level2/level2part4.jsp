            ...
            <div class="level-c__content">
                ...
                <div class="col-10">
                    ...
                    <div class="row">
                        ...
                        <security:authorize access="hasRole('ROLE_L2P5')" var="nextLvl"/>
            ...
            $(document).ready(function () {
                    ...
                    $.post('/level2part4compile', JSON.stringify(dataPayload))
                        .done(function (response) {
                            ...
                            if (response["result"] === true) {
                                ...
                                $("#next").removeClass("btn-grey").addClass("btn-blue").attr("href", "${level2part5}");
                            } else {
                ...
                $("#writeComment").click(function () {
                    ...
                    if (comment === "") {
                        ...
                        var dataPayload = {"comment": comment, "theme": "24"};
