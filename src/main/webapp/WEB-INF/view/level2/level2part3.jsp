        ...
        <div class="level-c">
            ...
            <div class="level-c__content">
                ...
                <div class="col-10">
                    ...
                    <p><spring:message code="levels.level2.part3.task"/></p>
                    <form>
                    <textarea class="java-code"><spring:message
                            code="levels.level2.part3.task.about"/></textarea>
                    </form>
                    <br/>
                    ...
                    <div class="row">
                        ...
                        <security:authorize access="hasRole('ROLE_L2P4')" var="nextLvl"/>
            ...
            $(document).ready(function () {
                    ...
                    $.post('/level2part3compile', JSON.stringify(dataPayload))
                        .done(function (response) {
                            ...
                            if (response["result"] === true) {
                                ...
                                $("#next").removeClass("btn-grey").addClass("btn-blue").attr("href", "${level2part4}");
                            } else {
                ...
                $("#writeComment").click(function () {
                    ...
                    if (comment === "") {
                        ...
                        var dataPayload = {"comment": comment, "theme": "23"};
