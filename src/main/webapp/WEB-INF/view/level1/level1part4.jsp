...
<page:template>
    ...
    <jsp:attribute name="title"><spring:message code="levels.level1.part4"/></jsp:attribute>
                ...
                <div class="col-10">
                    ...
                    <form>
                        <textarea class="java-code"><spring:message
                                code="levels.level1.part4.declaring.about3"/></textarea>
                    </form>
                    <br/>
                    ...
                    <form>
                        <textarea class="java-code"><spring:message
                                code="levels.level1.part4.declaring.about10"/></textarea>
                    </form>
                    <br/>
                    ...
                    <form>
                        <textarea class="java-code"><spring:message
                                code="levels.level1.part4.declaring.about12"/></textarea>
                    </form>
                    <br/>
                    ...
                    <form>
                        <textarea class="java-code"><spring:message
                                code="levels.level1.part4.alternative.about3"/></textarea>
                    </form>
                    <br/>
                    ...
                    <form>
                        <textarea class="java-code"><spring:message
                                code="levels.level1.part4.alternative.about5"/></textarea>
                    </form>
                    <br/>
                    ...
                    <form>
                        <textarea class="java-code"><spring:message
                                code="levels.level1.part4.inference.about2"/></textarea>
                    </form>
                    <br/>
                    ...
                    <form>
                        <textarea class="java-code"><spring:message
                                code="levels.level1.part4.inference.about4"/></textarea>
                    </form>
                    <br/>
                    <p>
                    ...
                    <div class="row">
                        ...
                        <security:authorize access="hasRole('ROLE_L1P5')" var="nextLvl"/>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#compile").click(function () {
                    ...
                    $.post('/level1part4compile', JSON.stringify(dataPayload))
                        .done(function (response) {
                            ...
                            if (response["result"] === true) {
                                ...
                                $("#next").removeClass("btn-grey").addClass("btn-blue").attr("href", "${level1part5}");
                            } else {
                ...
                $("#writeComment").click(function () {
                    ...
                    if (comment === "") {
                        ...
                        var dataPayload = {"comment": comment, "theme": "14"};
