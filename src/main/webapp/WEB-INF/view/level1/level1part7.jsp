...
<page:template>
    ...
    <jsp:attribute name="title"><spring:message code="levels.level1.part7"/></jsp:attribute>
        ...
        <div class="level-c">
            ...
            <div class="level-c__content">
                ...
                <div class="col-10">
                    ...
                    <div class="row">
                        <a class="btn btn-blue" href="${level1part6}" role="button">
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#compile").click(function () {
                    ...
                    $.post('/level1part7compile', JSON.stringify(dataPayload))
                ...
                $("#writeComment").click(function () {
                    ...
                    if (comment === "") {
                        ...
                        var dataPayload = {"comment": comment, "theme": "17"};
