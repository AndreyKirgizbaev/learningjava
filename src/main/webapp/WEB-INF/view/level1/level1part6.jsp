...
<page:template>
    ...
    <jsp:attribute name="title"><spring:message code="levels.level1.part6"/></jsp:attribute>
            ...
            <div class="level-c__content">
                ...
                <div class="col-10">
                    ...
                    <div class="row">
                        ...
                        <security:authorize access="hasRole('ROLE_L1P7')" var="nextLvl"/>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#compile").click(function () {
                    ...
                    $.post('/level1part6compile', JSON.stringify(dataPayload))
                        .done(function (response) {
                            ...
                            if (response["result"] === true) {
                                ...
                                $("#next").removeClass("btn-grey").addClass("btn-blue").attr("href", "${level1part7}");
                            } else {
                ...
                $("#writeComment").click(function () {
                    ...
                    if (comment === "") {
                        ...
                        var dataPayload = {"comment": comment, "theme": "16"};
