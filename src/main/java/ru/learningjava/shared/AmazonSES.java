package ru.learningjava.shared;
...
import ru.learningjava.security.SecurityConstants;
...
public class AmazonSES {
    ...
    final String SUBJECT = "One last step to complete your registration with LearningJava";

    final String PASSWORD_RESET_SUBJECT = "Password reset request";

    // The HTML body for the email.
    final String HTMLBODY = "<h1>Please verify your email address</h1>"
            + "<p>Thank you for registering with our web app - LearningJava. To complete registration process and be able to log in,"
    ...
    final String TEXTBODY = "Please verify your email address. "
            + "Thank you for registering with our web app - LearningJava. To complete registration process and be able to log in,"
